...
public class AdminController {
    ...
    public ModelAndView edit(@ModelAttribute("user") UserModel userModel, ModelMap modelMap) {
    ...
    public ModelAndView create(@ModelAttribute("user") UserModel userModel, ModelMap modelMap) {
        modelMap.put("action", ACTION_CREATE_USER);
        return createUser(userModel, modelMap);
    }
